...
行動の粒度(Action Granularity)とは、リストに記述した行動の意味的粒度を指す。
...
ルーチンタスク(Routine Task)とは、定期的に実施するタスクを指す。LP においては定期的に行う行動と言い換えても良い。ルーチンタスクの例を以下に示す。
...
★人が抱えるタスクの大半はルーチンタスクであるか、またはルーチンタスクとして扱うことができるが、タスク管理を知らない者はこれらを管理できず、「思いついたときに実施する
