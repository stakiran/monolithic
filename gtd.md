...
★ [「タスクにコンテキストを付ける」と「タスクをコンテキストに置く」 - タスク管理に恋してる](https://ilovetaskmanagement.hatenablog.com/entry/2018/10/26/071300) ここ端的にまとめる

### [運用] 主な Context
★ [タスク管理におけるコンテキストとは何かを調べてみた - タスク管理に恋してる](https://ilovetaskmanagement.hatenablog.com/entry/2018/09/21/192652) この辺まとめる？
