...
Trigger リストは言い換えるなら「新たなネタを得るためのヒント集、質問集、チェックリスト」とも言える。
...
典型的には「～～について集めたい」場合に、どこかでまとまった時間を確保した後、「～～を集めるためのトリガーリスト」を読みながら、思いついたネタを書き留めていく……形になる。ネタは Inbox として蓄積することが多い。
