...
- 表現支援(EC - Expression Control)
  - タスクを記述しやすくする/使いやすいタスクや効果の高いタスクの(記述の)書き方に関する知見全般
  - キーワード: 条件擬似的な関係 ★2019/03/28 今見てピンと来なかった
  - ★2019/04/01 タスクをxxxタスクみたいに具現化するのと、擬似的な関係みたいに記述を工夫するのがある。前者は tm に押し込めそう？でも条件付きタスクは記述の工夫なので後者でしょ……。 / 使いやすい書き方という観点なら「具体的に書く」とか「30分以内に終わる粒度で」とかそういう話？ / 擬似的な関係は xxx タスクネーミングに変えられないか？フラットコンテナ（明示的コンテナの一種？いや明示的コンテナをタスクの記述内で表現したものか）とか / EC 要らない気がしてきた。幅が広すぎて扱えない。
