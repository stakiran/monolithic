...
# このドキュメントについて
[タスク管理](task_management.md) を支援する周辺ハックの体系化を試みた文書である。ただし主なタスク管理手法については [こちら](task_management_methods.md) を参照。
...
★今さらだが価値観系リストはどうしよう。ドリームリストやらGTDの5000mやら杞憂リストやらそういう系のリストは自己啓発系で腐るほどあるのだが……タスク管理関係ないというとそうだが、タスクの取捨選択時に使うことになるというと関係あるとも言えるし……
