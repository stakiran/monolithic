...
### デスク/Desk
各ユーザーが使える個人ワークスペース。1-user 1-desk で、自分が所属する n-project の更新情報やウォッチ情報などを要約表示する。

表示する情報の例

- 参加しているプロジェクト一覧
- 最近自分が書いたトピック/ページ/共同リンク集
- ★ブックマークやウォッチの内容
    - ここは FAQ で言及してるアシスト次第
    - 受動的に確認できる手段と、能動的に確認できる手段がともにあると良い 🐰
...
- トピックの表示内容が「自分が書いたページ」になる
    - 前述のデフォルトページを押しのける
    - まだ自分がページを書いていない場合、空白ページになる
    - もちろん他のページも表示される
