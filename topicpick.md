...
## トピックピックとは
**トピックに対する記述が最大n人分並ぶ** というコミュニケーションや情報共有の形態のこと。

トピックという対象に各自の棒（記述）をぶっ刺す、というニュアンス。
...
しかしビジネスは違う。ビジネスではコラボレーションが常だ。空気はある。遠慮も必要だ。ゆえに停滞する。有能なリーダーがいなければ、まともに機能しないか、ゴミしか生まれない。
