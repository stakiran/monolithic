...
# ●misc
- 終わりが見えることを管理する、終わりが見えないことも管理する ← この辺分類する。直感的に3,4くらいある臭いがする
- クローズしてから動かすタイプと、開いたまま動的に動かしていくタイプ ← 私は後者。tritask 上のデイリータスクは割と開いてて、「これ明日でいいや」「あ、これ今からやろっと」が割と柔軟にできる。まあ「高い目標抱えすぎずのんびり生きる」「毎日定時を余裕で守れるラインを死守する」「本質的にカオスになりがちな人付き合い系はなるべく避ける」といった前提があるせいでもあるが
- [すべてはタスクです。そしてリピートタスクです - 佐々木正悟のライフハック心理学](http://nokiba.hatenablog.jp/entry/2019/05/24/192141) リピートマン。何でもとりあえずルーチン化すること。自分が起こした行動は（たとえその時にはタスク管理で予定されていなかったとしても）自分にとって必要だから生じたのであって、また生じる可能性が高い。なのでルーチン化しておけば、次生じた時も管理しやすい。
