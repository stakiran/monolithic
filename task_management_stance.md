...
## リーサル
リーサル(Lethal)とは身体的、精神的、社会的に致命傷を負うこと。たとえば死亡、重症、解雇、(精神疾患者が薬を切らしたことによる)混乱、逮捕、(特に大きなステータスを持ち、かつそれが唯一の価値になっている場合において、それを一瞬で失わせてしまうようなレベルの)スキャンダルなど。
...
★m比率。一日のうちmust taskが占める割合。 ← must の定義が要るなぁ。たとえば「数時間、数日、一週間、一ヶ月間やらなかったらリーサルになる」こんなふうに期間で。食事睡眠排泄は含められる。 / should は二ヶ月以上かなぁ？備えにあたるもの。受験勉強とかもこれかな。もうちょっと長くてもいい？半年とか。
...
- 機械は嫌いだ
- 手書きとか汚いし遅いし空間コスト取るしで無理

## Task As A Key と Task As A Value
キーとしてのタスク(Task As A Key)とは、対象を思い出すためのヒントとしてタスクを扱う立場。

バリューとしてのタスク(Task As A Value)とは、対象そのものを記す手段としてタスクを扱う立場。
