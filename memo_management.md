...
- メモアプリの例などは筆者環境(Windows PC のみ利用。Mac/Linux/Android/iOS は使っていない)がベースとなっていることが多い
...
検討内容には「タスク」と「アイデア」がある。タスクのメモでは [想起](#想起) を狙う。アイデアのメモでは [連想](#連想) を狙う。ただしアイデアのメモのうち、リアルタイムにメモと連想を行っていくものは [超越連想としてのメモ](#超越連想としてのメモ) という別スタンスになる。
...
- [Microsoft OneNote](https://ja.wikipedia.org/wiki/Microsoft_OneNote)
  - 呼び名はセクション、ページ
  - ツリーという概念は存在するが、明示的には見せていない
- [CatMemoNote](http://www.cc9.ne.jp/~pappara/catmemonote.html)
  - 呼び名はタブ、ツリー、メモ
- [CintaNotes - A Note-Taking Application for Windows](http://cintanotes.com/)
  - 呼び名は Section、Note
  - ツリーという概念は少なくとも自認してはいないが、これはフラットで新規順固定のツリーだと言うことができる
