...
# misc
主なプロトコル。選択肢にiconつける。iconの下にぶら下げる。検討残骸。サマリー。脱線の切り出し。ニュアンス違いそうな言葉の定義を問う。コンテキストを問う。わからない人が書きわかる人が答える。たたき台を出す。投票。 / ダイナミック・プロトコルという形で丸投げしていたが、デザインパターンみたいにパターン化した方が優しいかもしれない。 ← 一通りscrapboxでまとめたあと、リンクでも張ろうか
...
プレゼンス。discordみたいに参加者がどの議題にいるかを示す。が、管理につながるので微妙？いや、折衷案取りたい。どこが盛り上がっているかがわかるが、離席なども許容する。カーソルが出るとサボってるのバレるから、出るモード出ないモードを切り替えられるといい。カーソルミュート、とか。
