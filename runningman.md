...
- ダンスラなど関連事項に関する知識は(知っていることを)前提としていることがある
...
# ランスペ
ランスペとはランニングマンスペック(your Runningman Specification)の略であり、ランニングマンの性質を定量的に表した指標。7 つの要素から成る。ランスペを用いることにより、特定のランニングマンを定量的な言葉で表現できる。
