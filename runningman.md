...
## シャトルランニングマン
曲中絶えずランニングマンを行い、パネル上を何回往復できるかを競う。ただしスコアは 90% 以上でなくてはならない 。
...
## SSS
SSS(Strong Smooth Style)とはランニングマンによる滑らかな移動に特化した自己表現。2019/07/15 現在では筆者により開発途上。

### 筆者仮説
- 滑らかな移動だけでも(最低限自分を、そして出来れば他人を唸らせるほどの)表現になり得るのではないか
- SSS はその性質上、上半身マスクをしていても映えるはずである
  - :warinng: 足の動きだけで魅せたいという筆者の嗜好も否定はできないが……
- 引き幅や上げ幅が大きくなくても映えるはずである
...
- 曲中絶えず動き続けられる程度の持久力
  - 止まると滑らかさも消える
- ファーストブースト
  - 初回からフルスロットルまたはそれに近いレベルで激しく動くこと
  - 滑らかさを感じられるまでには時間がかかるので、最初からブーストして早く感じてもらう
- 縦横無尽
  - パネル上の上下左右を動き回ること
  - 動き回れば視聴者の視点をずらすことができ、上半身など全体的なダンスとしての「映え」を見ようとすることを防止できる
  - この防止は重要。ダンスラはダンスパフォーマンスの映えが第一に要求されやすいため、ここを封じなければ視聴者の意識が「滑らかさ」に落ちてこない
- 省エネとしてのTステップやスピン etc
  - ランニングマンばかりだと疲れる
  - ランニングマンばかりだと「あ、ノーツに届かない」というタイミングがある
  - これらの対策として、ランニングマンメインを削がない程度にTステップやスピンを入れる
  - その他スポンジボブやストンプなども適宜
- ……
