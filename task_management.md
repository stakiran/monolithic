...
## 駆動方式
★なんか違う
★taskchute trita taskuma / redmine trello dashboard... / gtd ←この辺上手く言い表したいの。tritask とかは「今日はこれだけやればいい」が把握されてる。他リストも使うけど、全部そこから辿れるようになってる（ルーチンタスク仕込んで忘れず辿るようにする）。

エントリーポイント。まず最初にここを見ろ、をつくる。
...
★ふと思った タスク管理は時刻的管理と日付的管理に二分できるのでは？「タスク管理の主要機能」的なくくりにする？主要のうちどこまで持たせるか、的な。日付管理、時刻管理、ログ管理、みたいな
...
★ライトなタスク管理。ヘビーなタスク管理。良いネーミングかも。taskuma 等で一日分ガッツリ管理するのがヘビー。 / プロジェクトタスク、チームタスク、「ライフタスク」←こういう観点？ライフ≒ルーチンでは？タスクって言葉に意味付けしようってのがそもそもだめで抽象性は保つべきか？/密度の問題？一日の行動のうちどこまでを管理するか。密度が濃いはガッツリ、密度は薄いが一部だけ（特に特定の作業や「やること」だけ） / 時系列ってのが違うかも。ヘビーなのは日単位カテゴリ使ってることが前提、でも使ってないのも多い / 密度かな。一日のうちどこまでタスク管理に突っ込んでいるか。24h時間中の、24→フル、12→ミドル、
...
- 毎日m時n分 ★Todoistが扱ってる時単位頻度どうしよ。頻度というと日のイメージなんだがなぁ……
  - 毎日15時
  - 毎日15時30分
- n日毎
  - 1日毎
...
★LVつけたい。1と2満たしたらLV2とか、全部満たしたらLV5とか。tritaskは1と2だけ。todoistはたぶん全部
★厳密な繰り返しとゆるい繰り返し。ゆるい繰り返しは1月=30日と日単位でしてて厳密じゃない(2月は27or28日しかないとか)、tritaskはゆるい。
...
「プロジェクト」という言葉の定義は特に無いが、「XXX プロジェクト」「家事」「書籍 YYYY の執筆」「引越し」など、きりのいいゴールの単位で設けることが多い。
...
★リッチ、を上手いこと定義したいのだが/サイズが定まるもの。あるいは定めても支障が出ないもの←これはどう？/あとは常駐と非常駐。アラーム系は常駐必要だからリッチ。/他システムに依存するものもリッチ。連携系はアウツ。/繰り返しは @1 とかで簡単に記述できるし、非常駐で操作時に解釈して操作できるからセーフ？
...
- ズーム
  - 元は Dynalist の概念
  - 箇条書き一つ分にファイル一つ分の記入領域を追加する
- TTaM 系色々あるよね……
  - タグの延長: バージョン、コンポーネント、……、あとはカスタムもある
