...
### フレンドリッチ
フレンドリッチ(Friend Rich)とは他システムへの何らかの依存を含むパラメーターであること。
...
★フレンドリッチだめかも。タスク to 他のシステム方向を考えたけど、あるのは他のシステム to タスク(他システム上のデータをタスクとして流し込む)方向だけ。

### カスタムリッチ
カスタムリッチ(Custom Ritch)とはユーザーが独自の属性を定義できる仕組みを持っていること。あるいはそれによって定義されたパラメーターであること。
