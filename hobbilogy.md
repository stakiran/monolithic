...
- 1: その場の一瞬一瞬で発揮しなければ先に進めない趣味(FPS、演劇、演奏、球技格闘技全般)
- つくったものを保存しながら足していける趣味(絵、小説、楽譜、プログラミング)
- つくったものを保存しながら足していけるが、保存するものは一瞬一瞬で発揮しなければつくれない趣味(DTM、BMSなど音楽ゲーム譜面作成、1:をコンテンツとした動画)
