...
# 趣味とは
趣味とは「人間が取り組んで楽しむことのできる行動や対象」であり、かつ「明確に名前がついている」または「名前がついてなくても言語化できる」ものを指す。

この定義では「仕事かどうか」「実力の有無」「習慣性の有無や程度」といった条件は考慮しない。これを広義の定義という。

逆に何らかの条件を追加で定義したものを狭義の定義という。
